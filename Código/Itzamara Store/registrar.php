            ...
            <div class="alto seccion-formulario bg-primary container w-50 my-5  text-formulario justify-content-center border">
                <div class="data">
                    <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="m-5" method="post">
                        ...
                        <br>
                        <label for="numero" class="inicia">N&uacute;mero de contacto</label>
                        <br/>
                        <input type="numer" class="inicia" name="numero" id="numero" maxlength="10" placeholder="Ingresa tu n&uacute;mero de contacto" >
                        <span style="color: red; font-weight: bold;"><?php echo $tel_error; ?></span>
                        <br>
