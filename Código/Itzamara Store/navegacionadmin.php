...
<body>
    <header class="encabe">
        <div class="Logo">
            <a class="navText" href="./inicio.php"><img src="./static/img/Logo.png" class="logito" alt="Logo"></a>    
        </div>
        <nav>
            <li><a class="navText" href="./inventario.php"><span > Inventario </span></a></li>
            <li><a class="navText" href="./ventas.php"><span > Ventas </span></a> </li>
